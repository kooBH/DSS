...
traj_pts = 100  # Number of trajectory points

pos_traj = np.tile(np.array([0.0,2.5,1.7]), (traj_pts,1))

pos_traj[:,0] = np.linspace(0.1, 4.9, traj_pts) # Positions of the trajectory points [m]
pos_traj[:,2] = np.linspace(1.0, 2.4, traj_pts) # Positions of the trajectory points [m]
