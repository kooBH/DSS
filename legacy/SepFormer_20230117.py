...
class SepFormerSeparator(nn.Module):
    ...
    def __init__(self, N, C, H, K, Global_B, Local_B):
        ...
        super(SepFormerSeparator, self).__init__()
        # Temporal detour
        C = 1
        self.N = N
        self.C = C
    ...
    def split_feature(self, input, segment_size):
        ...
        # split into chunks with size of segments
        # input : (B, N, T)
...
class Sepformer(nn.Module):
    ...
    def pad_signal(self, input):
        ...
        nsample = input.size(2)  # length of single data
